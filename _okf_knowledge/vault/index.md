...
* **Starter**: [Extending OKF](concepts/extending-okf.md) · [OKF Cognitive Bundle](concepts/okf-cognitive-bundle.md)
* **Ingest**: Drop material in [`_inbox/`](/_inbox/) and follow [Maintain OKF System](playbooks/maintain-okf-system.md)
...
* **Serve**: `python3 _okf_knowledge/kernel/okf.py serve` (read-only okf-brain visualizer)
